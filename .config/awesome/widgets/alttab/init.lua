...
local function preview()
    ...
    local textboxHeight = screen[mouse.screen].geometry.height / 40
    local w = screen[mouse.screen].geometry.width * (33.33/100) + (2 * preview_wbox.border_width) -- widget width
