...
shellexecute('picom', 'picom --daemon --dbus')
...
shellexecute('synology-note-station', 'bash -l -c "kdocker -d 60 ~/.syno_ns_app/synology-note-station 1>/dev/null 2>&1"')
shellexecute('nm-applet', 'nm-applet 1>/dev/null')
shellexecute('goldendict', 'goldendict')
--shellexecute('caffeine', 'caffeine')
shellexecute('blueman-applet', 'blueman-applet')
...
shellexecute('polychromatic-tray-applet', 'polychromatic-tray-applet', true, true)
shellexecute('volumeicon', 'dbus-launch volumeicon', true, true)
