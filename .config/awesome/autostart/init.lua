...
shellexecute('blueman-applet', 'blueman-applet 1>/dev/null 2>&1')
shellexecute('/usr/bin/libinput-gestures', 'bash -c "/usr/bin/libinput-gestures-setup restart" 1>/dev/null 2>&1')
shellexecute('volumeicon', '/usr/bin/volumeicon', true, true)
...
shellexecute('openrgb --profile', '/usr/bin/openrgb --profile LightsOff --startminimized', true, true)
