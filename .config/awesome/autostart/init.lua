...
-- run_once('synology-note-station', 'kdocker -d 30 -l -i /home/hacksign/.syno_ns_app/package.nw/icon/NoteStation_32.png .syno_ns_app/launch.sh 1>/dev/null 2>&1')
run_once('nm-applet', 'nm-applet 1>/dev/null')
run_once('fcitx', 'fcitx-autostart 1>/dev/null 2>&1')
run_once('goldendict', 'goldendict')
-- run_once('thunderbird', 'kdocker -d 10 -l thunderbird')
...
run_once('blueman-applet', 'bash -c /usr/bin/blueman-applet 1>/dev/null 2>&1')
